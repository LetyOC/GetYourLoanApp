...
function generateRickProfile(la) {
    ...
    var summaryText = foo `Dear ${la.ApplicantName}, your application for ${"$" + la.LoanAmount},
        ${reviewText} .Your risk profile is  ${riskProfile}. Your unique application code is \t${createApplicationId()}`;
